...
class HotelListData {
  ...
  static List<HotelListData> romeList = [
    HotelListData(
        ...
        perNight: 180,
        dateTxt: 'Sleeps 2 adult + 2 children',
        roomData: RoomData(2, 2, 2)),
    HotelListData(
        imagePath:
