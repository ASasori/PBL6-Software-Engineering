                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        '${bookingData.hotelName} - ${bookingData.roomType} x 1 day',
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text('\$${bookingData.pricePernight.toString()} USD', style: const TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: const [
                          ...
                          Text('-\$30 USD', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600)),
                        ],
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          ...
                          Text('\$${(bookingData.pricePernight - 30).toString()} USD',
