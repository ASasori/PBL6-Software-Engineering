...
const Login = ({ onLogin }) => {
    const handleSubmit = (e) => {
        ...
        onLogin(); // Gọi hàm onLogin để thay đổi trạng thái đăng nhập
    };
        ...
        <section className="flex items-center justify-center min-h-screen bg-gray-50">
            <div className="flex items-center max-w-3xl p-5 bg-gray-100 shadow-lg rounded-2xl">
                <div className="px-8 md:w-1/2 md:px-16">
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-4"> {/* Thêm onSubmit */}
                        <input className="p-2 mt-8 border rounded-xl" type="email" name="email" placeholder="Email" required />
                        <div className="relative">
                            <input className="w-full p-2 border rounded-xl" type="password" name="password" placeholder="Password" required />
